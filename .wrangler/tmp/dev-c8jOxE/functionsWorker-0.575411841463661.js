...
// .wrangler/tmp/pages-Q3UsiQ/functionsWorker-0.575411841463661.mjs
...
var inert = /* @__PURE__ */ __name2((reason) => json({ ok: false, reason }), "inert");
...
var adminOk = /* @__PURE__ */ __name2((request, env) => !!env.ADMIN_TOKEN && safeEqual(request.headers.get("x-admin-token") || "", env.ADMIN_TOKEN), "adminOk");
var sameOrigin = /* @__PURE__ */ __name2((request) => {
...
__name2(randomHex128, "randomHex128");
...
var waConfigured = /* @__PURE__ */ __name2((env) => !!(env.WA_CLOUD_TOKEN && env.WA_CLOUD_PHONE_ID), "waConfigured");
...
__name2(sendTemplate, "sendTemplate");
...
__name2(fireStatusHooks, "fireStatusHooks");
...
__name2(alreadyProcessed, "alreadyProcessed");
...
__name2(findByToken, "findByToken");
...
async function onRequestPatch2(context) {
  ...
  const sets = [];
  const binds = [];
  const text = /* @__PURE__ */ __name2((field, max) => {
...
async function onRequestPost8(context) {
  const { request, env } = context;
  const reply = /* @__PURE__ */ __name2((ok, reason) => new Response(JSON.stringify(reason ? { ok, reason } : { ok }), {
    status: 200,
    headers: { "Content-Type": "application/json" }
  }), "reply");
...
var median = /* @__PURE__ */ __name2((xs) => {
  if (!xs.length) return null;
  const s = [...xs].sort((a, b) => a - b);
  const m = Math.floor(s.length / 2);
  return s.length % 2 ? s[m] : (s[m - 1] + s[m]) / 2;
}, "median");
var r2 = /* @__PURE__ */ __name2((n) => Math.round(n * 100) / 100, "r2");
...
async function onRequestGet4(context) {
  ...
  const reached = /* @__PURE__ */ __name2((o, s) => reachedAt[o.id]?.[s], "reached");
  const count = /* @__PURE__ */ __name2((f) => orders.filter(f).length, "count");
  ...
  const payoutPctOf = /* @__PURE__ */ __name2((o) => {
  ...
  const sourceOf = /* @__PURE__ */ __name2((o) => {
    try {
...
var str = /* @__PURE__ */ __name2((v, max) => typeof v === "string" && v.trim() ? v.trim().slice(0, max) : null, "str");
...
var parseJsonCols = /* @__PURE__ */ __name2((row) => ({
  ...row,
...
// .wrangler/tmp/bundle-kliFcU/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-kliFcU/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.575411841463661.js.map
